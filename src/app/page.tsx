  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#0a0a12]">
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-between p-8 md:p-12">
        ...
        >
          {/* Logo */}
          <motion.div variants={titleVariants} className="flex items-center gap-3 mb-2">
            <div className="relative">
              <Sparkles className="w-8 h-8 text-amber-400" />
              <div className="absolute inset-0 w-8 h-8 bg-amber-400/30 blur-lg" />
            </div>
            <span className="text-amber-500/60 text-sm font-medium tracking-widest">
              Ver. 0.1.0
            </span>
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl font-bold text-white mb-1"
          ...
          {/* 副标题 */}
          <motion.div variants={titleVariants} className="flex items-center gap-4">
            <div className="w-12 h-px bg-gradient-to-r from-amber-500/60 to-transparent" />
            <p className="text-amber-200/70 text-lg tracking-wide" style={{ fontFamily: 'Noto Serif SC, serif' }}>
              AI驱动的房东模拟器
            </p>
          </motion.div>
        </motion.div>
        ...
        {/* 右下角菜单 */}
        <motion.div 
          className="absolute bottom-12 right-8 md:right-16 flex flex-col items-end gap-3"
          initial="hidden"
          animate="visible"
          variants={containerVariants}
        >
          ...
          <motion.a
            ...
            className="group flex items-center gap-3 px-6 py-3 mb-6 bg-[#5865F2]/20 hover:bg-[#5865F2]/30 
          ...
          >
            ...
            <span className="text-white/90 font-medium">使用 Discord 登录</span>
          </motion.a>
            ...
            >
              ...
              <div 
                className={`h-px bg-gradient-to-r from-transparent to-amber-500/60 transition-all duration-500 ${
                  hoveredButton === item.id ? 'w-16 opacity-100' : 'w-8 opacity-40'
                }`}
              />
              ...
              <div className="relative flex items-center gap-3 px-6 py-4">
                <div className="text-right">
                  ...
                  <div className="text-xs text-amber-500/50 tracking-widest font-medium">
                    {item.sublabel}
                  </div>
                </div>
                ...
                >
                  <ChevronRight className="w-6 h-6 text-amber-400/80" />
                </motion.div>
              </div>
            </motion.a>
          ))}
          ...
          <motion.div variants={itemVariants} className="mt-4 flex items-center gap-4">
            <a 
              href="/login" 
              className="text-amber-500/60 hover:text-amber-400 text-sm transition-colors flex items-center gap-1"
            >
        ...
        {/* 底部版权信息 */}
        <motion.div 
          className="absolute bottom-4 left-8 text-white/20 text-xs"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-amber-500/20 to-transparent border border-amber-500/30 
