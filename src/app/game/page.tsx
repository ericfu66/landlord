        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className={`glass-card p-6 transition-all duration-700 delay-200 ${mounted ? 'fade-in-up' : 'opacity-0'}`}>
            ...
            <div className="space-y-3">
              ...
              {stats.weather && (
                <div className="stat-bar flex justify-between items-center group">
                  <span className="text-gray-400 group-hover:text-gray-300 transition-colors">天气</span>
                  <span className="font-semibold text-amber-400 flex items-center gap-2">
              ...
              <button
                ...
                disabled={advancing}
                className="w-full mt-4 py-2.5 px-4 bg-gradient-to-r from-amber-500 to-orange-500 rounded-xl text-white font-medium hover:opacity-90 transition-opacity flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {advancing ? (
                  <>
